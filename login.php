...
<body>
    ...
    <div class="container">
        <div class="toflex">
            ...
            <div class="thethreetext">
                ...
                <div class="changing-text" id="logthree">
                    ...
                    <div class="changing-content" id="thethird">Experience movies like never before in our Dolby Atmos
                        Theatres</div>
                </div>
            </div>
        </div>
        <form method="POST" name="loginform" class="loginbox">
            ...
            <div class="subflex">
                <i class="fas fa-user"></i><input type="text" placeholder="Username" name="username"
                    class="logintextbox" required>
            </div>
            <div class="subflex">
